    ...
    public void loadLevel(int level) throws Exception {
        ...
        try {
            ...
            if ((line = reader.readLine()) != null) {
                // The first line of a level file contains 3 configuration parameters
                // 1. Map width
                // 2. Map height
                // 3. Tileset file name
                ...
                // Since we are not using multiple tilesets, we ignore the last parameter
            } else {
        ...
        // The second layer is objects - things that can be walked through and interacted with
        // These objects are displayed behind the player
        // The third layer is for objects to be displayed in front of the player, such as lights
                ...
                for (int y = 0; y < rows; y++) {
                    for (int x = 0; x < cols; x++) {
                        ...
                        try {
                            ...
                            throw new Exception("The map file for level " + level
                                                + " references non-existing tile with ID " + tileID);
                        }
